...
namespace exEngine
{
	// Events in exEngine are currently blocking, meaning when an event occures
	// it immediately gets dispatched and must be dealt with right then an there.
	// For the future, the better strategy would be to buffer events in an event bus
	// and process them during an "event" part of the update stage. 
	...
	enum class event_type
	{
		...
		mouse_button_pressed, mouse_button, mouse_button_released, mouse_moved, mouse_scrolled 
	};
